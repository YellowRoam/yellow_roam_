...
logic = [
    {
        "patterns": [
            ...
            "How do I get a Yellowstone fishing permit?",
            "Are fishing permits required in the park?"
        ],
    ...
    {
        "patterns": [
            "Are barbed hooks allowed in Yellowstone?",
            "Do I need to use barbless hooks?",
            "Can I use regular fishing hooks?"
        ],
    ...
    {
        "patterns": [
            "Can I use lead tackle in Yellowstone?",
            "Is lead sinker fishing allowed?",
            "Are lead jigs or weights legal?"
        ],
    ...
    {
        "patterns": [
            "What are the gear restrictions for anglers?",
            "Can I use multiple rods or lures?",
    ...
    {
        "patterns": [
            "Can I release rainbow trout in Lamar River?",
            "What should I do with rainbow trout?",
            "Is catch-and-release allowed for rainbow trout?"
        ],
    ...
    {
        "patterns": [
            "Are felt-soled wading boots allowed?",
            "Can I wear felt boots in Yellowstone?",
            "Why are felt boots banned?"
        ],
    ...
    {
        "patterns": [
            "Can I bring live bait into the park?",
    ...
    {
        "patterns": [
            "Where can kids fish in Yellowstone?",
            "Best places for young anglers?",
