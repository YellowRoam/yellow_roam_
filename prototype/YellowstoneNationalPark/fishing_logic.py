logic = [
    ...
    {
        "patterns": ['Can kids fish in Yellowstone without a permit?', 'What’s the fishing rule for children?', 'Do kids need a permit to fish?'],
    ...
    {
        "patterns": ['Are barbed hooks allowed in Yellowstone?', 'Do I need to use barbless hooks?', 'Can I use regular fishing hooks?'],
    ...
    {
        "patterns": ['Can I use lead tackle in Yellowstone?', 'Is lead sinker fishing allowed?', 'Are lead jigs or weights legal?'],
    ...
    {
        "patterns": ['What are the gear restrictions for anglers?', 'Can I use multiple rods or lures?', 'How many rods can I use?'],
    ...
    {
        "patterns": ['Can I release rainbow trout in Lamar River?', 'What should I do with rainbow trout?', 'Is catch-and-release allowed for rainbow trout?'],
    ...
    {
        "patterns": ['What should I do with lake trout in Yellowstone Lake?', 'Can I release lake trout?', 'What’s the rule for lake trout?'],
    ...
    {
        "patterns": ['Are felt-soled wading boots allowed?', 'Can I wear felt boots in Yellowstone?', 'Why are felt boots banned?'],
    ...
    {
        "patterns": ['Can I bring live bait into the park?', 'Is bait fishing allowed in Yellowstone?', 'What kind of bait is permitted?'],
    ...
    {
        "patterns": ['Where can kids fish in Yellowstone?', 'Best places for young anglers?', 'Kid-friendly fishing spots?'],
